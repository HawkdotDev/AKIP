const Blogs = () => {
  return (
    ...
    //               <a
    //                 href=""
    //                 className="px-3 py-1 rounded-full border-black  border"
    //               >
    //                 2024 Memo
    //               </a>
    //             </div>
    ...
    //             <div className="h-[60%] bg-slate-500 rounded-3xl relative overflow-hidden">
    //               <img
    //                 src=""
    //                 alt=""
    //                 className="bg-blue-600 h-full object-cover absolute"
    ...
    //             </div>
    //           </div>
    //           <div className="w-[35.5%] h-full flex flex-col justify-between bg-green-500 rounded-3xl relative overflow-hidden">
    //             <img
    //               src=""
    //               alt=""
    //               className="bg-blue-600 h-full object-cover absolute"
    ...
    //       <img
    //         src="https://static.toiimg.com/photo/msid-93369915,width-96,height-65.cms"
    //         alt="Solar panels"
    ...
    <div className="h-screen flex justify-center items-center">
      <div className="h-1/2 w-[50vw] bg-black/20 flex justify-center items-center text-3xl rounded-3xl text-center">
