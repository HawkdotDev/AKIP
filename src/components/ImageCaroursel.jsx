...
import image1 from "../assets/images/Maintenance.jpg";
                ...
                <div className="flex h-[370px] bg-[#E6E6E6] justify-between">
                  ...
                  <div className="p-8 md:p-12 flex flex-col justify-center">
                    <div className="max-w-lg">
                      ...
                      <p className="text-black mb-6 md:text-lg leading-relaxed sm:text-md text-sm">
                        {slide.text}
                      </p>
                      ...
                      <p className="text-sm text-gray-500 md:mt-6 mt-2">
                        {slide.author}
                      </p>
                    </div>
                  </div>
